...
class DiskScheduler {
public:
    DiskScheduler(std::vector<int> requests, int initialPosition=0) : sid("22330034"),initialPosition_(initialPosition), requests_(std::move(requests)) {}
    std::string sid;
...
{
public:
    SCANDiskScheduler(std::vector<int> requests, int initialPosition = 0)
        : DiskScheduler(std::move(requests), initialPosition) {}
